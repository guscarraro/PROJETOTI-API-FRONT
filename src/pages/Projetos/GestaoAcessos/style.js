...
export const Title = styled.h1`
  ...
  font-size: 28px; font-weight: 900; letter-spacing: .2px; color: #111827;
  &::before{ content:""; width:8px; height:26px; border-radius:6px; background:#6366f1; display:inline-block; }
...
export const UserCard = styled.div`
  ...
  &:hover { transform: translateY(-2px); box-shadow: 0 12px 28px rgba(0,0,0,.10); }
  ...
  [data-theme="dark"] & {
    ...
    &:hover { box-shadow: 0 12px 32px rgba(2,6,23,.65); }
  }
`;
...
export const Chip = styled.span`
  ...
  ${(p)=>p.$accent && css`
    color: #065f46; background: rgba(16,185,129,.14); border-color: rgba(16,185,129,.35);
  `}

  [data-theme="dark"] & {
    color: #e5e7eb; background: #0b1220; border-color: rgba(255,255,255,.08);
    ${(p)=>p.$accent && css`
      color: #34d399; background: rgba(16,185,129,.18); border-color: rgba(16,185,129,.5);
    `}
  }
`;
...
export const SectorChecks = styled.div`
  ...
  [data-theme="dark"] & label {
    background:#0b1220; border-color: rgba(255,255,255,.08); color:#e5e7eb;
  }
`;
...
export const Divider = styled.div`
  ...
  [data-theme="dark"] & { background: rgba(255,255,255,.08); }
`;

export const ModalOverlay = styled.div`
  position: fixed; inset:0; z-index: 2000; background: rgba(0,0,0,.25);
...
export const ModalBox = styled.div`
  ...
  [data-theme="dark"] & {
    ...
    box-shadow: 0 20px 44px rgba(2,6,23,.7);
  }
`;
...
export const Field = styled.div`
  ...
  [data-theme="dark"] & {
    label { color:#cbd5e1; }
    input { background:#0b1220; color:#e5e7eb; border-color: rgba(255,255,255,.08); }
  }
`;
...
export const Danger = styled.button`
  ...
  [data-theme="dark"] & {
    background: rgba(239,68,68,.14); border-color: rgba(239,68,68,.4); color:#fca5a5;
  }
`;
...
export const Help = styled.div`
  ...
  [data-theme="dark"] & { color:#94a3b8; code { background:#0b1220; } }
`;
