...
export const DeleteBtn = styled.button`
  ...
  &:hover {
    ...
    border-color: rgba(239,68,68,.45); /* red-500 */
  ...
  [data-theme="dark"] & {
    ...
    &:hover {
      ...
      background: rgba(239,68,68,.18);  /* red-500 @18% */
...
export const LockBtn = styled.button`
  ...
  &:hover {
    transform: translateY(-1px);
    box-shadow: 0 8px 16px rgba(0,0,0,.08);
    background: ${p => p.$locked ? "rgba(16,185,129,.16)" : "rgba(16,185,129,.08)"};
    border-color: ${p => p.$locked ? "rgba(16,185,129,.50)" : "rgba(16,185,129,.30)"};
    color: ${p => p.$locked ? "#065f46" : "#047857"};
  }

  [data-theme="dark"] & {
    background: ${p => p.$locked ? "rgba(16,185,129,.18)" : "#0f172a"};
    border-color: ${p => p.$locked ? "rgba(16,185,129,.50)" : "rgba(255,255,255,.08)"};
    color: ${p => p.$locked ? "#34d399" : "#e5e7eb"};
    box-shadow: 0 8px 16px rgba(2,6,23,.4);

    &:hover {
      box-shadow: 0 10px 18px rgba(2,6,23,.55);
      background: ${p => p.$locked ? "rgba(16,185,129,.24)" : "rgba(16,185,129,.14)"};
      border-color: ${p => p.$locked ? "rgba(16,185,129,.60)" : "rgba(16,185,129,.45)"};
      color: #34d399;
    }
  }
`;
