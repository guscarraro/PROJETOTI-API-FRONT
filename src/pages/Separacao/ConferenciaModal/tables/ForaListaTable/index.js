...
const RED_BG = "rgba(239,68,68,.10)";    // fraco
const RED_BORDER = "rgba(239,68,68,.45)"; // forte
const ROW_BG = "rgba(239,68,68,.06)";     // linhas
              ...
              <tr key={i}>
                ...
                <td style={tdBg()}>
                  <Button
                    ...
                    title="Confirmar devolução ao local de origem"
                  >
