    ...
    <NavbarContainer>
      ...
      <NavButton
        ...
        className={
          ...
          isActive("Paletizacao") ||
          isActive("Armazenagem")
            ? "active"
            : ""
        }
      >
      ...
      <NavButton
        ...
        className={
          ...
          isActive("todasPaletizacoes") ||
          isActive("todasArmazenagens")
            ? "active"
            : ""
        }
      >
      ...
      <NavButton onClick={() => navigate("/SAC")}>
        <NavIcon>
          <FaCaretDown style={{ transform: "rotate(-90deg)" }} />
        </NavIcon>
        Ir para SAC
      </NavButton>
    </NavbarContainer>
